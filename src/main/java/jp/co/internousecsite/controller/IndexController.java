...
import jp.co.internousecsite.model.dto.HistoryDto;
import jp.co.internousecsite.model.form.CartForm;
import jp.co.internousecsite.model.form.HistoryForm;
...
import jp.co.internousecsite.model.mapper.TblPurchaseMapper;
...
public class IndexController {
	...
	public int purchaseApi(@RequestBody CartForm f) {
		...
		//Listやファイルなどのオブジェクト名.foreach((引数)->{処理});
